...
function fetchapi(){
    ...
    .then(data=>{console.log(data.data.data[0].sold)})
}
    ...
    <div className="px-5 pb-5">
        ...
        <div className="flex items-center mt-2.5 mb-5">
            <div className="flex items-center space-x-1 rtl:space-x-reverse">
                <svg className="w-100 h-100 font-yellow" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
